...
var AppComponent = /** @class */ (function () {
    function AppComponent(fb, postalCodeService) {
        this.fb = fb;
    ...
    AppComponent.prototype.ngOnInit = function () {
        ...
        this.codesForm
            .get('userInput')
            .valueChanges
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["debounceTime"])(300), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["distinctUntilChanged"])(), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function () { return _this.isLoading = true; }))
            .subscribe(function (value) {
            return _this.postalCodeService.find(value).subscribe(function (results) {
                _this.filteredCodes = results;
...
var PostalCodeService = /** @class */ (function () {
    ...
    PostalCodeService.prototype.find = function (value) {
